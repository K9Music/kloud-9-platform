      ...
      <main className="flex-1 bg-gradient-to-br from-slate-900 via-cyan-900 to-slate-900 px-6 py-12 md:px-12 lg:px-24">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-white mb-4">How to view your public profile</h1>
            <p className="text-xl text-cyan-200 mb-4 italic">See how others view your profile</p>
          </div>
          <div className="bg-slate-800 rounded-2xl p-8 border border-cyan-900 text-cyan-100 text-lg space-y-6">
            <ol className="list-decimal list-inside space-y-2">
              <li>Go to your profile page.</li>
              <li>Click the <b>View Public Profile</b> button at the top right of your profile dashboard.</li>
              <li>Your public profile will open in a new tab, showing how others see your profile.</li>
